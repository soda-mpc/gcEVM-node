...
func (b *SimulatedBackend) callContractAtHead(ctx context.Context, call ethereum.CallMsg) ([]byte, error) {
	...
	res, err := b.callContract(ctx, call, b.blockchain.CurrentBlock(), stateDB, false)
	if err != nil {
		return nil, err
	}
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call ethereum.CallMsg) ([]byte, error) {
	...
	res, err := b.callContract(ctx, call, b.pendingBlock.Header(), b.pendingState, false)
	if err != nil {
		return nil, err
	}
	// If the result contains a revert reason, try to unpack and return it.
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call ethereum.CallMsg) (uint64, error) {
	...
	executable := func(gas uint64) (bool, *core.ExecutionResult, error) {
		...
		res, err := b.callContract(ctx, call, b.pendingBlock.Header(), b.pendingState, true)
...
func (b *SimulatedBackend) callContract(ctx context.Context, call ethereum.CallMsg, header *types.Header, stateDB *state.StateDB, forEstimation bool) (*core.ExecutionResult, error) {
	...
	if forEstimation {
		vmEnv.IsGasEstimated = true // Set the flag to true for simulated gas estimation
	}
