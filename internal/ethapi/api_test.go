...
func TestRPCMarshalBlock(t *testing.T) {
	...
	block := types.NewBlock(&types.Header{Number: big.NewInt(100)}, txs, nil, nil, blocktest.NewHasher(), nil)
...
func TestRPCGetBlockOrHeader(t *testing.T) {
	...
	var (
		...
		pending = types.NewBlockWithWithdrawals(&types.Header{Number: big.NewInt(11), Time: 42}, []*types.Transaction{tx}, nil, nil, []*types.Withdrawal{withdrawal}, blocktest.NewHasher(), nil)
	)
