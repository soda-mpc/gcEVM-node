...
func (tt *TestCmd) RunSoda(name string, args ...string) {
	// Basic Soda args without which the test will fail
	args = append([]string{"--soda.sequencer", "--soda.exec1addr=0xff7acc5fe1cbb331cfccf323c692569ccbbae072",
		"--soda.exec2addr=0xff7acc5fe1cbb331cfccf323c692569ccbbae072"}, args...)
	tt.Run(name, args...)
}
