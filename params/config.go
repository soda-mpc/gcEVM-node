...
type ChainConfig struct {
	...
	Co2       *Co2Config    `json:"co2,omitempty"`
...
// Co2Config is the consensus engine configs for the gcEVM blockchain.
...
type EmissionsConfig struct {
	FoundationAccount     common.Address `json:"foundationAccount"`     // The recipent address for epoch-based minted coins
	CoinMintingStartTime  uint64         `json:"coinMintingStartTime"`  // Timestamp to start minting coins
	SecondsInMintingEpoch uint64         `json:"secondsInMintingEpoch"` // Number of seconds between coin minting rate reductions
	MintingInterval       uint64         `json:"mintingInterval"`       // Interval of blocks to mint coins
