...
var (
	...
	requiredGasMap = map[struct {
		...
		{signature: signatureDecrypt, bits: 128}:               12006,
		{signature: signatureBitXor, bits: 128}:                12006,
		{signature: signatureAdd, bits: 128}:                   12340,
		{signature: signatureCheckedAdd, bits: 128}:            12340,
		{signature: signatureSub, bits: 128}:                   12679,
		{signature: signatureCheckedSub, bits: 128}:            12679,
		{signature: signatureMul, bits: 128}:                   54233,
		{signature: signatureCheckedMul, bits: 128}:            54233,
		{signature: signatureDiv, bits: 128}:                   76377,
		{signature: signatureRem, bits: 128}:                   76377,
		{signature: signatureMin, bits: 128}:                   13012,
		{signature: signatureMax, bits: 128}:                   13012,
		{signature: signatureLt, bits: 128}:                    12679,
		{signature: signatureGt, bits: 128}:                    13012,
		{signature: signatureGe, bits: 128}:                    12679,
		{signature: signatureLe, bits: 128}:                    13012,
		{signature: signatureEq, bits: 128}:                    12334,
		{signature: signatureNe, bits: 128}:                    12334,
		{signature: signatureTransfer, bits: 128}:              13685,
		{signature: signatureTransferWithAllowance, bits: 128}: 14527,
		{signature: signatureMux, bits: 128}:                   12332,
