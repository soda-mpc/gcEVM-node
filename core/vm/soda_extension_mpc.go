...
var (
	...
	requiredGasMap = map[struct {
		...
		{signature: signatureMul, bits: 8}:                    12293,
		{signature: signatureCheckedMul, bits: 8}:             12656,
		{signature: signatureDiv, bits: 8}:                    12448,
		{signature: signatureRem, bits: 8}:                    12448,
		{signature: signatureShl, bits: 8}:                    12293, // Same as multiplication
		{signature: signatureShr, bits: 8}:                    12448, // Same as division
		...
		{signature: signatureMul, bits: 16}:                   13247,
		{signature: signatureCheckedMul, bits: 16}:            14649,
		{signature: signatureDiv, bits: 16}:                   13590,
		{signature: signatureRem, bits: 16}:                   13590,
		{signature: signatureShl, bits: 16}:                   13247, // Same as multiplication
		{signature: signatureShr, bits: 16}:                   13590, // Same as division
		...
		{signature: signatureMul, bits: 32}:                   17151,
		{signature: signatureCheckedMul, bits: 32}:            22628,
		{signature: signatureDiv, bits: 32}:                   17910,
		{signature: signatureRem, bits: 32}:                   17910,
		{signature: signatureShl, bits: 32}:                   17151, // Same as multiplication
		{signature: signatureShr, bits: 32}:                   17910, // Same as division
		...
		{signature: signatureMul, bits: 64}:                   32946,
		{signature: signatureCheckedMul, bits: 64}:            54561,
		{signature: signatureDiv, bits: 64}:                   34691,
		{signature: signatureRem, bits: 64}:                   34691,
		{signature: signatureShl, bits: 64}:                   32946, // Same as multiplication
		{signature: signatureShr, bits: 64}:                   34691, // Same as division
		...
		{signature: signatureBitAnd, bits: 128}:                12640,
		{signature: signatureBitOr, bits: 128}:                 12678,
		{signature: signatureSetPublic, bits: 128}:             12012,
		{signature: signatureDecrypt, bits: 128}:               12012,
		{signature: signatureBitXor, bits: 128}:                12012,
		{signature: signatureAdd, bits: 128}:                   12685,
		{signature: signatureCheckedAdd, bits: 128}:            12690,
		{signature: signatureSub, bits: 128}:                   13364,
		{signature: signatureCheckedSub, bits: 128}:            13364,
		{signature: signatureMul, bits: 128}:                   96485,
		{signature: signatureCheckedMul, bits: 128}:            182324,
		{signature: signatureDiv, bits: 128}:                   100816,
		{signature: signatureRem, bits: 128}:                   100816,
		{signature: signatureShl, bits: 128}:                   96485,  // Same as multiplication
		{signature: signatureShr, bits: 128}:                   100816, // Same as division
		{signature: signatureMin, bits: 128}:                   14029,
		{signature: signatureMax, bits: 128}:                   14029,
		{signature: signatureLt, bits: 128}:                    13364,
		{signature: signatureGt, bits: 128}:                    14029,
		{signature: signatureGe, bits: 128}:                    13364,
		{signature: signatureLe, bits: 128}:                    14030,
		{signature: signatureEq, bits: 128}:                    12673,
		{signature: signatureNe, bits: 128}:                    12673,
		{signature: signatureTransfer, bits: 128}:              15381,
		{signature: signatureTransferWithAllowance, bits: 128}: 19433,
		{signature: signatureMux, bits: 128}:                   12665,
		{signature: signatureOnboard, bits: 128}:               47039,
		{signature: signatureValidateCiphertext, bits: 128}:    47039,
		{signature: signatureOffboard, bits: 128}:              47052,
		{signature: signatureOffboardToUser, bits: 128}:        47052,
		{signature: signatureBitAnd, bits: 256}:                13280,
		{signature: signatureBitOr, bits: 256}:                 13356,
		{signature: signatureSetPublic, bits: 256}:             12025,
		{signature: signatureDecrypt, bits: 256}:               12025,
		{signature: signatureBitXor, bits: 256}:                12025,
		{signature: signatureAdd, bits: 256}:                   13376,
		{signature: signatureCheckedAdd, bits: 256}:            13382,
		{signature: signatureSub, bits: 256}:                   14733,
		{signature: signatureCheckedSub, bits: 256}:            14734,
		{signature: signatureMul, bits: 256}:                   351359,
		{signature: signatureCheckedMul, bits: 256}:            693441,
		{signature: signatureDiv, bits: 256}:                   363318,
		{signature: signatureRem, bits: 256}:                   363318,
		{signature: signatureShl, bits: 256}:                   351359, // Same as multiplication
		{signature: signatureShr, bits: 256}:                   363318, // Same as division
		{signature: signatureMin, bits: 256}:                   16065,
		{signature: signatureMax, bits: 256}:                   16065,
		{signature: signatureLt, bits: 256}:                    14734,
		{signature: signatureGt, bits: 256}:                    16065,
		{signature: signatureGe, bits: 256}:                    14733,
		{signature: signatureLe, bits: 256}:                    16065,
		{signature: signatureEq, bits: 256}:                    13351,
		{signature: signatureNe, bits: 256}:                    13351,
		{signature: signatureTransfer, bits: 256}:              18773,
		{signature: signatureTransferWithAllowance, bits: 256}: 26882,
		{signature: signatureMux, bits: 256}:                   13331,
		{signature: signatureOnboard256, bits: 256}:            82078,
		{signature: signatureValidateCiphertext256, bits: 256}: 82078,
		{signature: signatureOffboard256, bits: 256}:           82103,
		{signature: signatureOffboardToUser256, bits: 256}:     82103,
		...
		{signature: signatureRand, bits: 128}:                  6000,
		{signature: signatureRand, bits: 256}:                  6000,
		...
		{signature: signatureRandBoundedBits, bits: 128}:       6000,
