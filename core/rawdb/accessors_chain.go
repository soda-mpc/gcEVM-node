...
func ReadBlock(db ethdb.Reader, hash common.Hash, number uint64) *types.Block {
	...
	return types.NewBlockWithHeader(header).WithBody(body.Transactions, body.Uncles).WithWithdrawals(body.Withdrawals).WithSodaTypes(body.Transcript, body.SequencerHeader)
}
