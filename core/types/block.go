...
type Body struct {
	...
	Transcript      *Transcript   `rlp:"optional"`
	SequencerHeader *Header       `rlp:"optional"`
}
...
type Block struct {
	...
	sequencerHeader *Header
}

func (b *Block) GetTranscript() Transcript {
	return *b.transcript
}

func (b *Block) GetSequencerHeader() *Header {
	return b.sequencerHeader
}

func (b *Block) SetSequencerHeader(header *Header) {
	b.sequencerHeader = header
}
...
// and receipts.
func NewBlock(header *Header, txs []*Transaction, uncles []*Header, receipts []*Receipt, hasher TrieHasher, transcript *Transcript) *Block {
...
func NewBlockWithWithdrawals(header *Header, txs []*Transaction, uncles []*Header, receipts []*Receipt, withdrawals []*Withdrawal, hasher TrieHasher, transcript *Transcript) *Block {
	b := NewBlock(header, txs, uncles, receipts, hasher, transcript)
...
func (b *Block) DecodeRLP(s *rlp.Stream) error {
	...
	b.header, b.uncles, b.transactions, b.withdrawals, b.transcript, b.sequencerHeader = eb.Header, eb.Uncles, eb.Txs, nil, eb.Transcript, eb.SequencerHeader
...
func (b *Block) EncodeRLP(w io.Writer) error {
	return rlp.Encode(w, &extblock{
		...
		SequencerHeader: b.sequencerHeader,
	})
}
...
func (b *Block) Body() *Body {
	return &Body{b.transactions, b.uncles, b.withdrawals, b.transcript, b.sequencerHeader}
}
...
func (b *Block) WithSodaFields(transcript *Transcript, seqHeader *Header) *Block {
	block := &Block{
		header:       b.header,
		transactions: b.transactions,
		uncles:       b.uncles,
	...
	if seqHeader != nil {
		block.sequencerHeader = seqHeader
	}
	return block
}
